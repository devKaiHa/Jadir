              ...
              <tr>
                <td className="p-2 pt-4">
                  <div className="input-group">
                    <span className="btn btn-input w-[20%]">Project Link</span>
                    <input
                      type="text"
                      className="input"
                      value={projectLink}
      ...
      <div className="lg:w-[35%] self-start">
        <div className="card">
          <div className="card-header">
            <h3 className="card-title">Project Image</h3>
          </div>
          ...
          <div className="p-6">
            <CrudAvatarUpload
              ...
              adviceMessage="Project Image | Max 1MB"
            />
          </div>
        </div>
      </div>
...
export default ProjectGeneralInfoTab;
